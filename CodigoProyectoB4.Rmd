...
#ggpairs(datos.salarios.raw %>% select(-job_title, -salary_currency, -salary, -employee_residence))
...
```{r}
resumen.salary1 <- descr(data1$salary_in_usd)
print(resumen.salary1, method="render")
MODELO <- lm(salary_in_usd~., data=data1)
MODELO
summary(MODELO)$r.squared
sigma(MODELO)
summary(MODELO)$r.squared
